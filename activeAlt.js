...
activeList.push(activeDevices)
console.log("Finally, the active LIst is", activeList)
...
console.log(data)
  ...
  var http= await fetch("https://dev.epcloud.ebmpapstneo.io/api/v1/integrations/http/0253b163-505c-2a80-bedd-7d7b9bd6a74a",
{
  headers: {
